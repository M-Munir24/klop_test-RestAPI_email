...
var html = `
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="from" value="Mark" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="to">to</label>
      <input type="text" class="form-control" id="to" value="Mark" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="subjek">Subjek</label>
      <input type="text" class="form-control" id="subjek" value="Mark" required>
    </div><br>
    <div class="col-md-6 mb-3">
      <label for="body">body</label>
      <textarea type="text" class="form-control" id="body" value="Mark" required></textarea>
    </div>
  </div>
